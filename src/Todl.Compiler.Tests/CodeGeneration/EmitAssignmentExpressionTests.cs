...
public sealed class EmitAssignmentExpressionTests
{
    ...
    public void TestEmitAssignmentExpressionWithStaticFields()
    {
        TestUtils.EmitStatementAndVerify(
            ...
            TestInstruction.Create(OpCodes.Ldc_I4_S, (sbyte)10),
            TestInstruction.Create(OpCodes.Stsfld, "System.Int32 Todl.Compiler.Tests.TestClass::PublicStaticIntField"));

        TestUtils.EmitStatementAndVerify(
            "Todl::Compiler::Tests::TestClass.PublicStaticStringField = \"abc\";",
            TestInstruction.Create(OpCodes.Ldstr, "abc"),
            TestInstruction.Create(OpCodes.Stsfld, "System.String Todl.Compiler.Tests.TestClass::PublicStaticStringField"));
    }
    ...
    public void TestEmitAssignmentExpressionWithInstanceFields()
    {
        TestUtils.EmitStatementAndVerify(
            ...
            TestInstruction.Create(OpCodes.Ldc_I4_S, (sbyte)10),
            TestInstruction.Create(OpCodes.Stfld, "System.Int32 Todl.Compiler.Tests.TestClass::PublicIntField"));

        TestUtils.EmitStatementAndVerify(
            "Todl::Compiler::Tests::TestClass.Instance.PublicStringField = \"abc\";",
            TestInstruction.Create(OpCodes.Ldsfld, "Todl.Compiler.Tests.TestClass Todl.Compiler.Tests.TestClass::Instance"),
            TestInstruction.Create(OpCodes.Ldstr, "abc"),
            TestInstruction.Create(OpCodes.Stfld, "System.String Todl.Compiler.Tests.TestClass::PublicStringField"));
    }
